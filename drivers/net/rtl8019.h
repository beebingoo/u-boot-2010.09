...
#define ADDR_SHF                8
#define RTL8019_REG_00			(RTL8019_BASE + (0x00 << ADDR_SHF))
#define	RTL8019_REG_01			(RTL8019_BASE + (0x01 << ADDR_SHF))
#define	RTL8019_REG_02			(RTL8019_BASE + (0x02 << ADDR_SHF))
#define	RTL8019_REG_03			(RTL8019_BASE + (0x03 << ADDR_SHF))
#define	RTL8019_REG_04			(RTL8019_BASE + (0x04 << ADDR_SHF))
#define	RTL8019_REG_05			(RTL8019_BASE + (0x05 << ADDR_SHF))
#define	RTL8019_REG_06			(RTL8019_BASE + (0x06 << ADDR_SHF))
#define	RTL8019_REG_07			(RTL8019_BASE + (0x07 << ADDR_SHF))
#define	RTL8019_REG_08			(RTL8019_BASE + (0x08 << ADDR_SHF))
#define	RTL8019_REG_09			(RTL8019_BASE + (0x09 << ADDR_SHF))
#define	RTL8019_REG_0a			(RTL8019_BASE + (0x0a << ADDR_SHF))
#define	RTL8019_REG_0b			(RTL8019_BASE + (0x0b << ADDR_SHF))
#define	RTL8019_REG_0c			(RTL8019_BASE + (0x0c << ADDR_SHF))
#define	RTL8019_REG_0d			(RTL8019_BASE + (0x0d << ADDR_SHF))
#define	RTL8019_REG_0e			(RTL8019_BASE + (0x0e << ADDR_SHF))
#define	RTL8019_REG_0f			(RTL8019_BASE + (0x0f << ADDR_SHF))
#define	RTL8019_REG_10			(RTL8019_BASE + (0x10 << ADDR_SHF))
#define	RTL8019_REG_1f			(RTL8019_BASE + (0x1f << ADDR_SHF))
